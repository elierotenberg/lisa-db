...
ALTER TABLE lisa_domain_category_locale
  ...
  ADD COLUMN lisa_domain_category_locale_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE lisa_domain_locale
  ...
  ADD COLUMN lisa_domain_locale_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE lisa_guide_locale
  ...
  ADD COLUMN lisa_guide_locale_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE lisa_domain_guide
  ...
  ADD COLUMN lisa_domain_guide_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE lisa_domain_guide_locale
  ...
  DROP COLUMN rank,
  ADD COLUMN lisa_domain_guide_locale_id uuid DEFAULT gen_random_uuid () PRIMARY KEY,
...
ALTER TABLE disorder_sign_symptom
  ...
  ADD COLUMN disorder_sign_symptom_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;

ALTER TABLE author
  DROP CONSTRAINT author_pkey CASCADE,
  ADD CONSTRAINT author_unique UNIQUE (first_initial, middle_initial, surname),
  ADD COLUMN author_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE disorder_reference_author
  ...
  ADD COLUMN disorder_reference_author_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE sign_symptom_neutral_construct
  ...
  ADD COLUMN sign_symptom_neutral_construct_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE sign_symptom_with_example
  ...
  ADD COLUMN sign_symptom_with_example_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE assessment_reference_author
  ...
  ADD COLUMN assessment_reference_author_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE questionnaire_language_not_mhdb
  ...
  ADD COLUMN questionnaire_language_not_mhdb_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE questionnaire_disorder
  ...
  ADD COLUMN questionnaire_disorder_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE questionnaire_disorder_category
  ...
  ADD COLUMN questionnaire_disorder_category_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE questionnaire_sign_symptom
  ...
  ADD COLUMN questionnaire_sign_symptom_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE questionnaire_respondent
  ...
  ADD COLUMN questionnaire_respondent_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE questionnaire_subject
  ...
  ADD COLUMN questionnaire_subject_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE questionnaire_assessment_reference
  ...
  ADD COLUMN questionnaire_assessment_reference_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE questionnaire_author
  ...
  ADD COLUMN questionnaire_author_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE guide_guide_type
  ...
  ADD COLUMN guide_guide_type_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE guide_disorder
  ...
  ADD COLUMN guide_disorder_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE guide_disorder_category
  ...
  ADD COLUMN guide_disorder_category_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE guide_audience
  ...
  ADD COLUMN guide_audience_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE guide_author
  ...
  ADD COLUMN guide_author_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE question_response_type
  ...
  ADD COLUMN question_response_type_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE disorder_intervention
  ...
  ADD COLUMN disorder_intervention_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE disorder_accommodation
  ...
  ADD COLUMN disorder_accommodation_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE disorder_technology
  ...
  ADD COLUMN disorder_technology_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE disorder_category_intervention
  ...
  ADD COLUMN disorder_category_intervention_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE disorder_category_accommodation
  ...
  ADD COLUMN disorder_category_accommodation_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE disorder_category_technology
  ...
  ADD COLUMN disorder_category_technology_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE sign_symptom_intervention
  ...
  ADD COLUMN sign_symptom_intervention_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE sign_symptom_accommodation
  ...
  ADD COLUMN sign_symptom_accommodation_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE sign_symptom_technology
  ...
  ADD COLUMN sign_symptom_technology_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE guide_intervention
  ...
  ADD COLUMN guide_intervention_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE guide_accommodation
  ...
  ADD COLUMN guide_accommodation_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE guide_technology
  ...
  ADD COLUMN guide_technology_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE intervention_research_evidence
  ...
  ADD COLUMN intervention_research_evidence_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE accommodation_research_evidence
  ...
  ADD COLUMN accommodation_research_evidence_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE technology_research_evidence
  ...
  ADD COLUMN technology_research_evidence_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE behaviour_intervention
  ...
  ADD COLUMN behaviour_intervention_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE behaviour_accommodation
  ...
  ADD COLUMN behaviour_accommodation_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE behaviour_technology
  ...
  ADD COLUMN behaviour_technology_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE behaviour_guide
  ...
  ADD COLUMN behaviour_guide_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
...
ALTER TABLE behaviour_questionnaire
  ...
  ADD COLUMN behaviour_questionnaire_id uuid DEFAULT gen_random_uuid () PRIMARY KEY;
